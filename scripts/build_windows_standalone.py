...
from transcribe.packaged_assets import (  # noqa: E402
...
from transcribe.runtime_defaults import (  # noqa: E402
...
def stage_runtime_assets(*, layout: BuildLayout, args: argparse.Namespace, icon_path: Path) -> None:
    ...
    write_packaged_asset_manifest(build_packaged_assets_manifest(), layout.stage_dir / "packaged-assets.json")
    stage_llama_runtime(
