...
[Icons]
Name: "{group}\Transcribe"; Filename: "{app}\Transcribe.exe"; IconFilename: "{app}\transcribe.ico"; Tasks: startmenuicon
Name: "{commondesktop}\Transcribe"; Filename: "{app}\Transcribe.exe"; IconFilename: "{app}\transcribe.ico"; Tasks: desktopicon
